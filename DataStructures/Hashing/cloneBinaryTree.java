...
class CloneABT {
    public static void main(String[] args)
    {
        ...
        //needs a better alocation method
    ...
    public static Tree cloneTree(Tree tree)
    {
        ...
        HashMap<Tree, Tree> map = new HashMap<>(); // create a hashmap to store the randoms
    ...
    public static Tree clonelr(Tree tree, HashMap<Tree, Tree> map)
    {
        if (tree == null)
        {
            return null;
    ...
    public static void copyrandom(Tree tree, Tree clone, HashMap<Tree, Tree> map)
    {
        if(clone == null)
        {
            return;
    ...
    static void printInorder(Tree node)
    {
        ...
        // First reccur on left subtree
        printInorder(node.left);
        //will kepp printing on left till end 
...
//binary trees are good. sort of like linked lists a bit more covoluted
